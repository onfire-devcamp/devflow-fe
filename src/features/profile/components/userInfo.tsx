  ...
  return (
    <div className="w-full flex flex-col gap-4">
      ...
      <Button
        ...
        className="w-full py-1.5 px-3 bg-gray-50 hover:bg-gray-100 border border-gray-300 rounded-md text-sm font-medium text-gray-700 transition-colors cursor-pointer"
      >
        Edit profile
      </Button>
