...
export function WorkspaceEditor({
  ...
  return (
    <div className="space-y-4 animate-fadeIn">
      ...
      {/* Read-Only Banner for Completed Files */}
      {isCompletedFile && (
      ...
      <div
        className={`w-full rounded-xl ${isCompletedFile ? 'rounded-tl-xl' : 'rounded-tl-none'} border border-slate-800 bg-slate-900 overflow-hidden shadow-md relative z-0`}
      >
